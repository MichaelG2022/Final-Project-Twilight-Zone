 ...
 * 
 * RequestMapping annotation tells Spring Boot to map all HTTP requests of /accessories to this
...
public interface TwilightAccessoryController {
  
//@formatter:off
 @Operation(
     summary = "Returns a list of lighting accessories",
     description = "Returns a list of accessories",
     responses = {
         @ApiResponse(
             responseCode = "200",
             description = "A list of accessories is returned", 
             content = @Content(
                 mediaType = "application/json", 
                 schema = @Schema(
                     implementation = Accessory.class))),
         @ApiResponse(
             responseCode = "400",
         ...
         @ApiResponse(
             responseCode = "404", 
             description = "No accessories were found", 
             content = @Content(
                 mediaType = "application/json")),
         @ApiResponse(
             responseCode = "500", 
     ...
     parameters = {
         @Parameter(             
             description = "Execute to return all accessories"),
     } // end parameters
 ) // end Operation
